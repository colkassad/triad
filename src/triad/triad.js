function() {
	...
	*/
	Triad.prototype.convexHull(pointFeatureCollection) {
		var self = this;
	...
	/*
	 * Returns the cross product of three points, used to determine if r is to the left or the right of the line through p and q
	...
	*/
	Triad.prototype.crossProduct = function(p, q, r) {
   		return (q.geometry.coordinates[0] - p.geometry.coordinates[0]) * (r.geometry.coordinates[1] - p.geometry.coordinates[1]) - (q.geometry.coordinates[1] - p.geometry.coordinates[1]) * (r.geometry.coordinates[0] - p.geometry.coordinates[0])
	};
